<?php
    ...
    $consulta2=$controlador->consultardatostabla(); //mandamos la consulta sql al modelo para ejecutarla
    ...
    if($consulta2[1]>0){
        ...
        header('Content-Disposition: attachment;filename="Listado de Profesores.xlsx"');
